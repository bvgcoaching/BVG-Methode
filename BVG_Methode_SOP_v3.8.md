...
VERSIE: v3.8 (concept ter review)
DATUM: 14 juni 2026
VORIGE: v3.7 (14 juni) <- v3.6 <- v3.5 <- v3.4 (12 juni 2026)
ENGINE: v1.9.0 (taak A+B geïmplementeerd & deels gevalideerd; zie status onder)

REPO (GitHub): bvgcoaching/BVG-Methode
  Bevat: engine_v1.9.0.py (=v1.9.3), bibliotheek_v1.9.json, deze SOP, STATUSRAPPORT_v1.9.3.md.
...
# DE BVG METHODE — COMPLETE SOP (v3.8)
